...
class ContactPage extends StatelessWidget {
  ...
  static const Color bgDark = Color(0xFF1A0505);
  static const Color primaryPurple = Color(0xFFE91E63);
  static const Color accentPurple = Color(0xFFFF80AB);
