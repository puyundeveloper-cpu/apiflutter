...
class _DashboardPageState extends State<DashboardPage>
  ...
  final Color cardDark = const Color(0xFF2A0F0F);
  final Color cardDarker = const Color(0xFF1A0A0A);
  ...
  void _initMenuVideo() {
    _menuVideoController = VideoPlayerController.asset('assets/videos/banner.mp4')
      ..initialize().then((_) {
        ...
        _menuVideoController?.setVolume(0.5);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.headset_mic_outlined, color: accentPink),
          ...
          IconButton(
            icon: const Icon(FontAwesomeIcons.userCircle, color: Color(0xFFFFAB40)),
            tooltip: 'My Profile',
            onPressed: () {
              Navigator.push(
                context,
