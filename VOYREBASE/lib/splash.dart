...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Background diubah menjadi sangat gelap dengan nuansa merah (Dark Maroon)
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  letterSpacing: 3,
                  shadows: [
                    // Shadow diubah menjadi Merah (Red Accent)
                    Shadow(
                      color: const Color(0xFFD50000).withOpacity(0.9),
                      blurRadius: 15,
